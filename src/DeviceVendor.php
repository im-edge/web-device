...
class DeviceVendor
{
    protected const VENDOR_OID_MAP = [
        ...
        '1.3.6.1.4.1.45.26' => 'nortel.svg', // TODO: find a better solution. This is in the Avaya MIB
        '1.3.6.1.4.1.45.27' => 'nortel.svg',
        '1.3.6.1.4.1.45.28' => 'nortel.svg',
        '1.3.6.1.4.1.45.29' => 'nortel.svg',
        '1.3.6.1.4.1.45.30' => 'nortel.svg',
        '1.3.6.1.4.1.45.31' => 'nortel.svg',
        '1.3.6.1.4.1.45.32' => 'nortel.svg',
        '1.3.6.1.4.1.45.33' => 'nortel.svg',
        '1.3.6.1.4.1.45.34' => 'nortel.svg',
        '1.3.6.1.4.1.45.35' => 'nortel.svg',
        '1.3.6.1.4.1.45.36' => 'nortel.svg',
        '1.3.6.1.4.1.45.37' => 'nortel.svg',
        '1.3.6.1.4.1.45.38' => 'nortel.svg',
        '1.3.6.1.4.1.45.39' => 'nortel.svg',
        '1.3.6.1.4.1.45.41' => 'nortel.svg',
        '1.3.6.1.4.1.45.42' => 'nortel.svg',
        '1.3.6.1.4.1.45.43' => 'nortel.svg',
        '1.3.6.1.4.1.45.45' => 'nortel.svg',
        '1.3.6.1.4.1.45.46' => 'nortel.svg',
        '1.3.6.1.4.1.45.51' => 'nortel.svg',
        '1.3.6.1.4.1.45.52' => 'nortel.svg',
        '1.3.6.1.4.1.45.53' => 'nortel.svg',
        '1.3.6.1.4.1.45.54' => 'nortel.svg',
        '1.3.6.1.4.1.45.57' => 'nortel.svg',
        '1.3.6.1.4.1.45.59' => 'nortel.svg',
        '1.3.6.1.4.1.45.61' => 'nortel.svg',
